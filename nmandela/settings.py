"""Django settings for nmandela project.

Minimal settings pre-configured for local development.
Remember to change SECRET_KEY and DEBUG for production.
"""
...
MIDDLEWARE = [
    ...
    'radio.middleware.VisitorTrackingMiddleware',
]

ROOT_URLCONF = 'nmandela.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'radio.context_processors.visitor_summary',
            ],
        },
    },
]

WSGI_APPLICATION = 'nmandela.wsgi.application'
